...
public class NavigationViewItem : System.Windows.Controls.Primitives.ButtonBase, INavigationViewItem
{
    ...
    public NavigationViewItem(string name, IconElement icon, Type targetPageType)
        : this(targetPageType)
    {
        SetValue(ContentProperty, name);
    ...
    public NavigationViewItem(string name, IconElement icon, Type targetPageType, IList menuItems)
